...
print(f'Тип выражения 15 * 3 = {type(15 * 3)}') #<class 'int'>
print(f'Тип выражения 15 / 3 = {type(15 / 3)}') #<class 'float'>
print(f'Тип выражения 15 // 2 = {type(15 // 2)}') #<class 'int'>
print(f'Тип выражения 15 ** 2 = {type(15 ** 2)}') #<class 'int'>
...
print(base_phrase)
# output: в "05" часов "17" минут температура воздуха была "+05" градусов
...
for i in price_list:
    if isinstance(i, float):
        ...
        str_price_list.append(f'{rub} руб {round(kk * 100)} коп')
    else:
        str_price_list.append(f'{i} руб 00 коп')

print(str_price_list)

# output: ['57 руб 80 коп', '46 руб 51 коп', '97 руб 00 коп', ...]
...
# output: 1938220205192 - id НЕ сортированного списка

price_list.sort()

print(f'{id(price_list)} - id сортированного списка')
# output: 1938220205192 - id сортированного списка

print(price_list)
# output: [0.5, 1.5, 15.3, 37.78, 46.51, 50, 57.8, 63.5, 97, 100]
